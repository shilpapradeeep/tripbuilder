              ...
              <div class="col-lg-11 col-xl-9 col-xxl-6">
                <div class="responsive-tabs text-lg-start nav-custom-dark view-animate fadeInUpSmall active" data-type="horizontal" style="display: block; width: 100%;">
                  ...
                  <ul class="nav-custom-tabs resp-tabs-list">
                    ...
                    <li class="nav-item resp-tab-item" aria-controls="tab_item-2" role="tab"><span class="icon mdi mdi-car"></span><span>Car Hire</span></li>
                  </ul>
                        ...
                        <div class="row row-20 row-md-23">
                          <div class="col-lg-8">
                            <div class="form-wrap radio-inline-wrapper">
                              ...
                              <label class="radio-inline">
                                <input name="input-group-radio" value="radio-3" type="radio" class="radio-custom"><span class="radio-custom-dummy"></span>Multi-city
                              </label>
                            </div>
                          </div>
                          <div class="col-lg-4 text-lg-end">
                            <div class="form-wrap">
                              <label class="checkbox-inline">
                                <input name="input-group-radio" value="checkbox-1" type="checkbox" class="checkbox-custom"><span class="checkbox-custom-dummy"></span>Direct Flights Only
                              </label>
                            </div>
                          </div>
                          <div class="col-12">
                            ...
                            <div class="row row-20 row-md-23 align-items-md-end">
                              <div class="col-12 col-sm">
                                <div class="form-wrap">
                                  ...
                                  <input class="form-input form-control-has-validation form-control-last-child" type="text" data-time-picker="date" data-constraints="@Required" name="departure" data-dtp="dtp_8b4hy" id="regula-generated-700172" fdprocessedid="zwqlob"><span class="form-validation"></span>
                                </div>
                              </div>
                              <div class="col-12 col-sm">
                                <div class="form-wrap">
                                  <label class="form-label-outside">Return</label>
                                  <input class="form-input form-control-has-validation form-control-last-child" type="text" data-time-picker="date" data-constraints="@Required" name="return" data-dtp="dtp_G5orO" id="regula-generated-851818" fdprocessedid="5i07hm"><span class="form-validation"></span>
                                </div>
                              </div>
                            ...
                            <div class="row row-20 row-md-23 align-items-md-end">
                              <div class="col-12 col-sm">
                                <div class="form-wrap">
                                  ...
                                  <input class="form-input form-control-has-validation form-control-last-child" type="text" data-time-picker="date" data-constraints="@Required" name="departure" data-dtp="dtp_eEDx3" id="regula-generated-678416"><span class="form-validation"></span>
                                </div>
                              </div>
                              <div class="col-12 col-sm">
                                <div class="form-wrap">
                                  <label class="form-label-outside">Leave</label>
                                  <input class="form-input form-control-has-validation form-control-last-child" type="text" data-time-picker="date" data-constraints="@Required" name="return" data-dtp="dtp_7l46l" id="regula-generated-550721"><span class="form-validation"></span>
                                </div>
                              </div>
                              <div class="col-md-6 col-xl-4">
                                <div class="row row-20 row-md-23">
                            ...
                            <div class="row row-20 row-md-23">
                              ...
                              <div class="col-12 col-sm">
                                <div class="form-wrap">
                                  ...
                                  <input class="form-input form-control-has-validation form-control-last-child" type="text" data-constraints="@Required @Integer" placeholder="000-000-000" id="regula-generated-978070"><span class="form-validation"></span>
                                </div>
                              </div>
                              <div class="col-12 col-sm">
                                <div class="form-wrap">
                            ...
                            <div class="row row-20 row-md-23 align-items-md-end">
                              <div class="col-12 col-sm">
                                <div class="form-wrap">
                                  ...
                                  <input class="form-input form-control-has-validation form-control-last-child" type="text" data-time-picker="date" data-constraints="@Required" name="departure" data-dtp="dtp_Vn3CM" id="regula-generated-642567"><span class="form-validation"></span>
                                </div>
                              </div>
                              <div class="col-12 col-sm">
                                <div class="form-wrap">
                                  <label class="form-label-outside">Drop-off Date</label>
                                  <input class="form-input form-control-has-validation form-control-last-child" type="text" data-time-picker="date" data-constraints="@Required" name="return" data-dtp="dtp_4bdG4" id="regula-generated-838401"><span class="form-validation"></span>
                                </div>
                              </div>
