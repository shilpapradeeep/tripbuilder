                                                ...
                                                <form id="contact_form" class="small" method="post" action="#">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input name="input-group-radio" name="flight_type" value="radio-1" type="radio" checked="" class="radio-custom"><span class="radio-custom-dummy"></span>Round Trip
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input name="input-group-radio" name="flight_type" value="radio-2" type="radio" class="radio-custom"><span class="radio-custom-dummy"></span>One Way
                                                        </label>
                                                        </div>
                                                        <span id="flight-type_error" class="error" style="color:red"></span>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-wrap">
